...
def generate_logo_svg(current_hexes):
    # キャンバスを 1000x950 に広げ、図形全体を <g transform="..."> で右下にズラして完全な余白を確保
    return f"""
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1050 1000" style="width:100%; max-width:200px; height:auto; margin:10px 0; overflow:visible;">
        <g transform="translate(17, 30)">
            <path d="M482.84,372.26c-102.49,0-185.88-83.38-185.88-185.88S380.35.5,482.84.5s185.88,83.38,185.88,185.88-83.38,185.88-185.88,185.88Z" fill="{current_hexes[0]}"/>
            <path d="M186.38,876.63C83.88,876.63.5,793.25.5,690.75s83.38-185.88,185.88-185.88,185.88,83.38,185.88,185.88-83.38,185.88-185.88,185.88Z" fill="{current_hexes[1]}"/>
            <path d="M779.3,876.63c-102.49,0-185.88-83.38-185.88-185.88s83.38-185.88,185.88-185.88,185.88,83.38,185.88,185.88-83.38,185.88-185.88,185.88Z" fill="{current_hexes[2]}"/>
        </g>
    </svg>"""
